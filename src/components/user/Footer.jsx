      ...
      <div className="w-full">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mt-4">
          <div className="text-sm mb-4 md:mb-0 md:mr-4">
            &copy; {new Date().getFullYear()} Connect By Edentu <br /> All
            rights reserved
          </div>
          <motion.div
